    ...
    public class StocksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StockID,StockName,StockBalance,BalanceStatus,AccountNumber,SecureNumber,StockType")] Stock stock)
        {
            ...
            foreach (var x in own)
            {
                ...
                {
                    return RedirectToAction("StockLimit", "Errors");
                }
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                Account AccountToAdd = new Account { ProductID = ProdID, ProductName = ProdName, ProductType = ProdType, ProductNumber = ProdNum, ProductString = ProdString, ProductBalance = ProdBal, Owner = StockOwner };
